        ...
        <section class="um-module-access-preview" id="moduleAccessPreview" hidden aria-labelledby="moduleAccessTitle">
            ...
            <div class="um-module-access-grid">
                <div class="um-module-item" data-module-item>
                    <div class="um-module-row">
                        <label class="um-module-option">
                            <input type="checkbox" name="module_permissions[]" value="appointments.view" data-module-permission data-clinic-staff="1" data-student-assistant="1">
                    ...
                    <div class="um-module-actions" id="appointmentPermissions" data-module-actions hidden>
                        ...
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="appointments.approve" data-module-action>
                        ...
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="appointments.reject" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Reject appointments</strong><small>Decline appointment requests</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="appointments.reschedule" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                ...
                <div class="um-module-item" data-module-item>
                    <div class="um-module-row">
                        <label class="um-module-option">
                            <input type="checkbox" name="module_permissions[]" value="walkin.view" data-module-permission data-clinic-staff="1" data-student-assistant="1">
                ...
                <div class="um-module-item" data-module-item>
                    <div class="um-module-row">
                        <label class="um-module-option">
                            <input type="checkbox" name="module_permissions[]" value="health_records.view" data-module-permission data-clinic-staff="1" data-student-assistant="1">
                    ...
                    <div class="um-module-actions" id="healthRecordPermissions" data-module-actions hidden>
                        <div class="um-module-actions-head"><strong>Additional permissions</strong><span>View access is included</span></div>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="health_records.review_documents" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                ...
                <div class="um-module-item" data-module-item>
                    <div class="um-module-row">
                        <label class="um-module-option">
                            <input type="checkbox" name="module_permissions[]" value="inventory.view" data-module-permission data-clinic-staff="1" data-student-assistant="1">
                    ...
                    <div class="um-module-actions" id="inventoryPermissions" data-module-actions hidden>
                        <div class="um-module-actions-head"><strong>Additional permissions</strong><span>View access is included</span></div>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="inventory.import" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Import inventory</strong><small>Upload inventory records from a file</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="inventory.add_stock" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Add stock</strong><small>Add quantities to an inventory item</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="inventory.manage" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                ...
                <div class="um-module-item" data-module-item>
                    <div class="um-module-row">
                        <label class="um-module-option">
                            <input type="checkbox" name="module_permissions[]" value="reports.view" data-module-permission data-clinic-staff="0" data-student-assistant="0">
                    ...
                    <div class="um-module-actions" id="reportPermissions" data-module-actions hidden>
                        ...
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="reports.mar" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>MAR Reports</strong><small>Medical accomplishment records</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="reports.inventory_summary" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Inventory Summary</strong><small>Stock movement and inventory levels</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="reports.health_forms" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Health Forms</strong><small>Issued health form summaries</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="reports.appointment_statistics" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                ...
                <div class="um-module-item" data-module-item>
                    <div class="um-module-row">
                        <label class="um-module-option">
                            <input type="checkbox" name="module_permissions[]" value="announcements.view" data-module-permission data-clinic-staff="0" data-student-assistant="0">
                    ...
                    <div class="um-module-actions" id="announcementPermissions" data-module-actions hidden>
                        <div class="um-module-actions-head"><strong>Additional permissions</strong><span>View access is included</span></div>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="announcements.publish" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Publish announcements</strong><small>Create and update clinic notices</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="announcements.archive" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                ...
                <div class="um-module-item" data-module-item>
                    <div class="um-module-row">
                        <label class="um-module-option">
                            <input type="checkbox" name="module_permissions[]" value="settings.view" data-module-permission data-clinic-staff="0" data-student-assistant="0">
                    ...
                    <div class="um-module-actions" id="settingsPermissions" data-module-actions hidden>
                        ...
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="settings.personal" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Personal Information</strong><small>Profile details and account identity</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="settings.clinic" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Clinic Information</strong><small>Clinic profile, contacts, and office hours</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="settings.preferences" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>System Preferences</strong><small>Workflow, reminders, and availability rules</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="settings.medical" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
                            <span><strong>Medical Configuration</strong><small>Medical conditions and medicine setup</small></span>
                        </label>
                        <label class="um-action-permission">
                            <input type="checkbox" name="module_permissions[]" value="settings.faqs" data-module-action>
                            <span class="um-action-check" aria-hidden="true"><x-outline-icon name="check" /></span>
