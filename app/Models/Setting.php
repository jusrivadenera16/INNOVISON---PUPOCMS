...
class Setting extends Model
{
    ...
    protected $fillable = [
        ...
        'pending_compliance_reminder_days',
    ...
    protected $casts = [
        ...
        'pending_compliance_reminder_days' => 'integer',
        'pending_compliance_reminder_max_count' => 'integer',
        'notification_quiet_hours_enabled' => 'boolean',
        'workflow_preferences_saved_at' => 'datetime',
