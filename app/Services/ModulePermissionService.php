...
class ModulePermissionService
{
    ...
    private const PARENT_PERMISSIONS = [
        ...
        'walkin.reference_lookup' => 'walkin.view',
        'walkin.employee_view' => 'walkin.view',
        'walkin.employee_lookup' => 'walkin.employee_view',
        'walkin.edit_information' => 'walkin.reference_lookup',
        ...
        'health_records.request_health_form' => 'health_records.view',
