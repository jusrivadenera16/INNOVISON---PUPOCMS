...
<head>
    ...
    <title><?php echo e($tabTitlePrefix); ?><?php echo $__env->yieldContent('title'); ?> - PUPT Admin</title>
    <link rel="icon" type="image/svg+xml" href="<?php echo e($tabIconData); ?>">
    <link rel="alternate icon" href="<?php echo e(asset('favicon.ico')); ?>">
    <script
        src="<?php echo e(asset('js/sienna-accessibility-custom.umd.js')); ?>?v=<?php echo e(filemtime(public_path('js/sienna-accessibility-custom.umd.js'))); ?>"
...
<body class="<?php echo e((request()->routeIs('admin.inventory*') || request()->routeIs('assistant.inventory*')) ? 'admin-inventory-page' : ''); ?> <?php echo e(request()->boolean('embed') ? 'admin-embedded-view' : ''); ?>">
<?php
    $authUser = auth()->user();
...
<header class="admin-header">
    <div class="header-left">
        <div class="header-brand-lockup">
            <img src="<?php echo e($brandUniversityLogo); ?>" alt="PUP Logo" class="header-brand-avatar">
            <img src="<?php echo e($brandLogo); ?>" alt="Clinic Logo" class="header-brand-avatar header-brand-avatar--clinic">
        </div>
        <div class="header-copy">
            <p class="header-kicker"><?php echo e($adminTypeLabel ? 'Clinic Administration' : ($isStudentAssistant ? 'Clinic Assistant Console' : 'Clinic Administration')); ?></p>
            <h1 class="header-title">Welcome back, <span><?php echo e($welcomeName); ?></span></h1>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'bars-3']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'bars-3']); ?>
...
<?php endif; ?>
        ...
        <button type="button" class="assistant-launch" id="assistantLaunchBtn" onclick="toggleAssistantPanel()">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'sparkles']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'sparkles']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
        ...
        <div class="quick-actions-wrap" id="headerQuickActions">
            <button type="button" class="quick-actions-toggle" aria-label="Open quick actions" aria-expanded="false" onclick="toggleHeaderQuickActions()">
                ...
                <?php if($adminNotificationCount > 0): ?>
                    <span class="quick-action-badge"><?php echo e($adminNotificationCount); ?></span>
                <?php endif; ?>
            </button>
            <div class="quick-actions-panel" id="headerQuickActionsPanel">
                <div class="quick-action-item">
                    <button type="button" class="quick-action-btn" id="openTreatmentRecordModal" aria-label="Daily Treatment Record">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'clipboard-document-list']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'clipboard-document-list']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                ...
                <div class="quick-action-item">
                    <a href="<?php echo e($walkinUrl); ?>" class="quick-action-btn" aria-label="Open Walk-in">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'qr-code']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'qr-code']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                ...
                <div class="quick-action-item">
                    <button type="button" class="quick-action-btn quick-action-bell" data-medicine-alert-toggle aria-label="Notifications">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'bell']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                ...
                <div class="quick-action-item">
                    <button type="button" class="theme-toggle-admin quick-action-btn" id="adminThemeToggle" aria-pressed="false" aria-label="Theme mode">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'sun']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'sun']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                ...
                <div class="quick-action-item is-accessibility">
                    <button type="button" class="accessibility-launch-admin quick-action-btn" id="adminAccessibilityLaunch" aria-label="Accessibility menu">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'accessibility-person']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'accessibility-person']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
        ...
        <div class="profile-wrap">
            <button type="button" class="admin-user" onclick="toggleProfileMenu()">
                <div class="admin-user-meta">
                    <div class="admin-user-name"><?php echo e($displayName); ?></div>
                    <div class="admin-user-role"><?php echo e($displayRole); ?></div>
                </div>
                <div class="user-avatar"><?php echo e($avatarInitial); ?></div>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'chevron-down','class' => 'admin-user-chevron']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'chevron-down','class' => 'admin-user-chevron']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
            ...
            <div id="profileDropdown" class="profile-dropdown">
                <?php if($isAdminLike): ?>
                    <a href="<?php echo e($settingsUrl); ?>">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'cog-6-tooth']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'cog-6-tooth']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <?php if($isStudentAssistant): ?>
                    <a href="<?php echo e(route('assistant.enter-student')); ?>" class="switch-student-link">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'user-plus']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                ...
                <a href="#" class="logout-link" onclick="event.preventDefault(); document.getElementById('layoutLogoutForm').submit();">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'arrow-left-on-rectangle']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'arrow-left-on-rectangle']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
  ...
  <aside class="sidebar" id="adminSidebar">
    <div class="sidebar-logo">
      ...
      <div class="sidebar-logo-text">
        ...
        <div class="sidebar-logo-sub"><?php echo e($adminTypeLabel ? 'Clinic Admin' : ($isStudentAssistant ? 'Clinic Assistant' : 'Clinic Admin')); ?></div>
      </div>
    </div>
    
    <h4>Main Menu</h4>
    <nav class="sidebar-nav">
      <a href="<?php echo e($dashboardUrl); ?>" class="nav-dashboard <?php echo e((request()->routeIs('admin.dashboard') || request()->routeIs('assistant.dashboard')) ? 'active' : ''); ?>">
        <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'squares-2x2']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'squares-2x2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Dashboard</span>
      </a>
      <a href="<?php echo e($appointmentsUrl); ?>" class="nav-appointments <?php echo e((request()->routeIs('admin.appointments*') || request()->routeIs('assistant.appointments*')) ? 'active' : ''); ?>">
        <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'calendar-days']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Appointments</span>
      </a>
      <a href="<?php echo e($inventoryUrl); ?>" class="nav-inventory <?php echo e((request()->routeIs('admin.inventory*') || request()->routeIs('assistant.inventory*')) ? 'active' : ''); ?>">
        <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'cube']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'cube']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Inventory</span>
      </a>
      <a href="<?php echo e($reportsUrl); ?>" class="nav-reports <?php echo e((request()->routeIs('admin.reports*') || request()->routeIs('assistant.reports*') || Request::is('admin/reports*') || Request::is('assistant/reports*')) ? 'active' : ''); ?>">
        <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'chart-bar']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Reports</span>
      </a>
     
      <a href="<?php echo e($walkinUrl); ?>" class="nav-walkin <?php echo e((Request::is('admin/walkin*') || Request::is('assistant/walkin*')) ? 'active' : ''); ?>">
        <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'user-plus']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Walk-in</span>
      </a>
      <a href="<?php echo e(route('admin.health_records')); ?>" class="nav-health <?php echo e((request()->routeIs('admin.health_records') || Request::is('health-records') || Request::is('health-profile/*')) ? 'active' : ''); ?>">
    <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'document-text']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'document-text']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?></span>
    <span class="sidebar-label">Health Records</span>
      ...
      <?php if($isAdminLike): ?>
          <a href="<?php echo e($userManagementUrl); ?>" class="nav-users <?php echo e((request()->routeIs('admin.user-management*') || Request::is('admin/user-management*')) ? 'active' : ''); ?>">
            <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'users']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Users Management</span>
          </a>
          <a href="<?php echo e(route('admin.logs')); ?>" class="nav-audit <?php echo e((request()->routeIs('admin.logs') || Request::is('admin/activity-logs*')) ? 'active' : ''); ?>">
            <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'clipboard-document-list']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Audit Trail</span>
          </a>
          <a href="<?php echo e($settingsUrl); ?>" class="nav-settings <?php echo e((request()->routeIs('admin.settings*') || Request::is('admin/settings*')) ? 'active' : ''); ?>">
            <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'cog-6-tooth']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Settings</span>
          </a>
      <?php endif; ?>
      <?php if($canSeeDeveloperTools): ?>
        <a href="<?php echo e($developerToolsUrl); ?>" class="<?php echo e((Request::is('admin/developer-tools*') || Request::is('assistant/developer-tools*') || Request::is('admin/api-testing*') || Request::is('assistant/api-testing*')) ? 'active' : ''); ?>">
          <span class="sidebar-short"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'code-bracket-square']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'code-bracket-square']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Developer Tools</span>
        </a>
      <?php endif; ?>
    ...
    <button type="button" class="sidebar-scroll-indicator" id="sidebarScrollIndicator" aria-label="Scroll navigation">
      <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'chevron-down']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?></span><span class="sidebar-label">Logout</span>
      </a>
    </div>
  </aside>
...
<form id="layoutLogoutForm" method="POST" action="<?php echo e(route('logout')); ?>" style="display:none;">
    <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <iframe
            ...
            data-src="<?php echo e($dailyTreatmentRecordUrl); ?>?embed=1"
            scrolling="yes"
        ></iframe>
    </section>
</div>
    ...
    <div class="medicine-alert-head">
        ...
        <div class="medicine-alert-actions">
            <button type="button" class="medicine-alert-mode-btn" id="medicineAlertBackBtn" aria-label="Back to new notifications">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'chevron-right','style' => 'transform: rotate(180deg);']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'chevron-right','style' => 'transform: rotate(180deg);']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
            ...
            <div class="medicine-alert-actions-menu" id="medicineAlertActionsMenu">
                    <form method="POST" action="<?php echo e($adminMarkAllReadUrl); ?>">
                        <?php echo csrf_field(); ?>
                        <?php $__currentLoopData = $adminNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input type="hidden" name="notification_ids[]" value="<?php echo e($notification['id']); ?>">
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <button type="submit" class="medicine-alert-actions-submit" <?php echo e($adminNotificationCount === 0 ? 'disabled' : ''); ?>>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'check']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                    ...
                    <button type="button" class="medicine-alert-actions-submit" id="medicineAlertHistoryBtn">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'clock']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
            ...
            <button type="button" class="medicine-alert-close" id="medicineAlertCloseBtn" aria-label="Close notifications">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'x-mark']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
    ...
    <div class="medicine-alert-list" id="medicineAlertList">
        <?php $__empty_1 = true; $__currentLoopData = $adminNotificationPreview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <article class="medicine-alert-item <?php echo e($notification['state_class']); ?>">
            <a
                href="<?php echo e($notification['link']); ?>"
                class="medicine-alert-item-link"
                data-admin-notification-link="true"
                data-admin-notification-target="<?php echo e($notification['link']); ?>"
                data-hover-hint="<?php echo e($notification['hover_hint']); ?>"
            >
            <div class="medicine-alert-content" style="width: 100%;">
                <div class="medicine-alert-name-row">
                    <p class="medicine-alert-item-name"><?php echo e($notification['title']); ?></p>
                </div>
                
                <div class="medicine-alert-item-meta">
                    <?php $__currentLoopData = $notification['chips']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="medicine-alert-chip"><?php echo e($chip); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <?php if($adminNotificationOverflow->isNotEmpty()): ?>
    <div class="medicine-alert-extra-list" id="medicineAlertExtraList">
        <?php $__currentLoopData = $adminNotificationOverflow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <article class="medicine-alert-item is-hidden <?php echo e($notification['state_class']); ?>" data-medicine-alert-extra="true">
            <a
                href="<?php echo e($notification['link']); ?>"
                class="medicine-alert-item-link"
                data-admin-notification-link="true"
    ...
    <div class="medicine-alert-section is-hidden" id="medicineAlertHistorySection">
        <div class="medicine-alert-list">
            <?php $__empty_1 = true; $__currentLoopData = $adminNotificationHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="medicine-alert-item <?php echo e($notification['state_class']); ?>">
                    <a
                        href="<?php echo e($notification['link']); ?>"
                        class="medicine-alert-item-link"
                    ...
                    <div class="medicine-alert-content" style="width: 100%;">
                        <div class="medicine-alert-name-row">
                            <p class="medicine-alert-item-name">
                                ...
                                <?php if(!($notification['is_unread'] ?? false)): ?>
...
<form method="POST" action="<?php echo e($adminMarkAllReadUrl); ?>" id="adminNotificationOpenForm" style="display:none;">
    <?php echo csrf_field(); ?>
    <?php $__currentLoopData = $adminNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <input type="hidden" name="notification_ids[]" value="<?php echo e($notification['id']); ?>">
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
        ...
        <a id="adminLiveAlertOpen" class="admin-live-alert-open" href="<?php echo e($appointmentsUrl); ?>">Open</a>
...
<script id="adminLiveAlertData" type="application/json"><?php echo json_encode($adminLiveAlertItems, 15, 512) ?></script>
<script id="adminLiveAlertFeedUrl" type="application/json"><?php echo json_encode($adminNotificationsFeedUrl, 15, 512) ?></script>
...
<?php endif; ?>
    ...
    <div class="assistant-controls">
        ...
        <button type="button" id="assistantSendBtn" class="assistant-send">
            <span>Send</span>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'arrow-long-right']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'arrow-long-right']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php echo $__env->make('partials.post_login_terms_gate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if (! empty(trim($__env->yieldContent('disable_voice_inputs')))): ?>
<?php else: ?>
<?php echo $__env->make('partials.student_voice_input_support', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>

<?php echo $__env->yieldPushContent('scripts'); ?>

<script>
    const assistantEndpoint = <?php echo json_encode($assistantEndpoint, 15, 512) ?>;
    ...
    function initAdminLiveAlerts() {
        const liveAlertsEnabled = <?php echo json_encode($adminLiveNotificationsEnabled, 15, 512) ?>;
        ...
        let unreadCount = <?php echo e((int) $adminNotificationCount); ?>;
        ...
        const storageKey = 'admin_live_alert_seen_' + String(<?php echo e((int) (optional(auth()->user())->id ?? 0)); ?>);
        let seenMap = {};
        try {
        ...
        const showNext = function () {
            ...
            openNode.setAttribute('href', item.link || '<?php echo e($appointmentsUrl); ?>');
...
<?php echo $__env->make('partials.system_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\INNOVISON---PUPOCMS\resources\views/layouts/admin.blade.php ENDPATH**/ ?>