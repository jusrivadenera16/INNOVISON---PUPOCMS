...
<?php if(session('show_terms_modal')): ?>
    <div class="post-login-loader" id="postLoginLoader" aria-live="polite" aria-label="Loading">
        <div class="post-login-loader-card">
            <img src="<?php echo e(asset('images/clinic_logo_transparent.png')); ?>?v=<?php echo e(filemtime(public_path('images/clinic_logo_transparent.png'))); ?>" alt="Loading" class="post-login-loader-logo">
    ...
    <form id="termsGateLogoutForm" method="POST" action="<?php echo e(route('logout')); ?>" style="display:none;">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="portal_guard" value="<?php echo e(request()->is('admin/*') || request()->is('assistant/*') || request()->is('health-records') || request()->is('health-profile/*') ? 'admin' : 'student'); ?>">
    </form>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\INNOVISON---PUPOCMS\resources\views/partials/post_login_terms_gate.blade.php ENDPATH**/ ?>