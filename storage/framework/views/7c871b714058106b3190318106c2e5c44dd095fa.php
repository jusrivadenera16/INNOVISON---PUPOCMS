...
<?php $__env->startSection('title', 'Health Records'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="health-records-toolbar">
        <h2 class="health-records-title"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.outline-icon','data' => ['name' => 'magnifying-glass']]); ?>
<?php $component->withName('outline-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'magnifying-glass']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
        ...
        <div class="summary-item">
            <div class="card p-3 health-summary-action-card health-summary-metric-card" style="padding: 15px 24px !important;">
                <div class="health-summary-row">
                    ...
                    <h3 class="health-summary-metric-count"><?php echo e($healthSummaryStats['total']); ?></h3>
                </div>
            </div>
        </div>
        <div class="summary-item">
            <div class="card p-3 health-summary-action-card health-summary-metric-card" style="padding: 15px 24px !important;">
                <div class="health-summary-row">
                    ...
                    <h3 class="health-summary-metric-count"><?php echo e($healthSummaryStats['with_conditions']); ?></h3>
                </div>
            </div>
        </div>
        <div class="summary-item">
            <button type="button" class="card p-3 awaiting-links-btn health-summary-info-btn" id="pendingApprovalInfoBtn" style="padding: 8px 18px 8px 12px !important; border-left: 5px solid #70131B; width: 100%; display: flex; align-items: center; justify-content: flex-start; gap: 12px; min-height: 90px;" onclick="document.getElementById('pendingApprovalInfoModal').style.display='flex';">
                ...
                <div class="workflow-card-text">
                    ...
                    <h3 class="workflow-card-count"><?php echo e($healthSummaryStats['pending_approval']); ?></h3>
                </div>
            </button>
        </div>
        <div class="summary-item">
...
<?php endif; ?>
                ...
                <div class="workflow-card-text">
                    ...
                    <h3 class="workflow-card-count"><?php echo e($healthSummaryStats['pending_conditional']); ?></h3>
                </div>
            </button>
        </div>
    </div>
...
<div class="card health-summary-card">
    ...
    <table id="healthTable">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $healthProfileSummaryRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <tr
                    data-health-row
                    data-health-id="<?php echo e($record->id); ?>"
                    data-health-tab="<?php echo e($healthTabState); ?>"
                    data-health-condition="<?php echo e($record->has_disability == 'Yes' ? 'with_conditions' : 'none'); ?>"
                    data-record-payload="<?php echo e(e(json_encode($recordPayload))); ?>"
                    data-view-url="<?php echo e(in_array($record->clearance_status, ['Issued', 'Fully Cleared'], true) ? route('admin.show_health', $record->id) : ''); ?>"
                    title="<?php echo e(in_array($record->clearance_status, ['Issued', 'Fully Cleared'], true) ? 'Click to view' : ''); ?>"
                    class="<?php echo e(implode(' ', array_filter([
                ...
                >
                    <td class="fw-bold"><?php echo e($record->user->student_number ?: $record->user->student_id); ?></td>
                    <td>
                        <div class="student-name" style="font-weight: 700;"><?php echo e($record->user->name); ?></div>
                    </td>
                    <td><?php echo e($record->course_college ?: $record->user->course); ?> <?php echo e($record->user->year); ?>-<?php echo e($record->user->section); ?></td>
                    ...
                    <td>
                        <?php if(in_array($record->clearance_status, ['Issued', 'Fully Cleared'], true)): ?>
                            <span class="status issued"><i class="fas fa-check-circle me-1"></i> Issued</span>
                        <?php elseif($record->clearance_status == 'Pending/Conditional'): ?>
                            <span class="status review">Pending/Conditional</span>
                        <?php elseif($record->clearance_status == 'Rejected'): ?>
                            <span class="status review">Rejected</span>
                        <?php elseif(in_array($record->clearance_status, ['Pending', 'For Verification'], true)): ?>
                    ...
                    <td style="color: #94a3b8; font-size: 12px;">
                        <?php echo e($record->created_at->format('M d, Y')); ?>

                    </td>

                    <td style="text-align: center;">
                        <div class="d-flex justify-content-center">
                            <a href="<?php echo e(route('admin.show_health', $record->id)); ?>" class="btn-action btn-view">
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
        ...
        <div class="awaiting-links-modal-body">
            <div class="pending-approval-list" id="pendingApprovalRecordsList">
                <?php $__empty_1 = true; $__currentLoopData = $records->whereIn('id', $pendingApprovalRecordIds); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $readonlyRecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $readonlyDocs = [
                            'Medical Certificate' => [
                    ...
                    <article class="readonly-record-card">
                        <div class="readonly-record-head">
                            <div>
                                <h4 class="readonly-record-name"><?php echo e(optional($readonlyRecord->user)->name ?: 'Unnamed Student'); ?></h4>
                                <p class="readonly-record-sub"><?php echo e(optional($readonlyRecord->user)->email ?: '-'); ?></p>
                            </div>
                            <div class="readonly-record-meta">
                                <div class="readonly-record-pill">
                                    ...
                                    <strong class="readonly-reference-value">
                                        <span><?php echo e($readonlyReference); ?></span>
                                        <?php if($readonlyReference !== '-'): ?>
                                            <button type="button" class="readonly-copy-btn" data-copy-reference="<?php echo e($readonlyReference); ?>" aria-label="Copy reference number">
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                        ...
                        <div class="readonly-record-details">
                            ...
                            <ul class="readonly-doc-list">
                                <?php $__currentLoopData = $readonlyDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docLabel => $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <?php if($document['path']): ?>
                                            <a
                                                class="readonly-doc-link"
                                                href="<?php echo e($document['url'] ?: route('walkin.document', [
                                                        'healthProfile' => $readonlyRecord->id,
...
<?php endif; ?>
        ...
        <div class="awaiting-links-modal-body">
            <div class="pending-approval-list">
                <?php $__empty_1 = true; $__currentLoopData = $records->whereIn('id', $pendingConditionalRecordIds); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $readonlyRecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="readonly-record-card">
                        <div class="readonly-record-head">
                            <div>
                                <h4 class="readonly-record-name"><?php echo e(optional($readonlyRecord->user)->name ?: 'Unnamed Student'); ?></h4>
...
<?php endif; ?>
                        ...
                        <div class="readonly-record-details">
                            <div class="readonly-record-grid">
                                ...
                                <div class="readonly-field"><span>Previous Nurse Disapproval Notes</span><strong><?php echo e($readonlyRecord->pending_reason ?: '-'); ?></strong></div>
                                <div class="readonly-field"><span>Student Full Name</span><strong><?php echo e(optional($readonlyRecord->user)->name ?: 'Unnamed Student'); ?></strong></div>
                                <div class="readonly-field"><span>Student ID Number</span><strong><?php echo e($readonlyRecord->student_id ?: optional($readonlyRecord->user)->student_id ?: optional($readonlyRecord->user)->student_number ?: '-'); ?></strong></div>
                                <div class="readonly-field"><span>Submission Reference Number</span><strong><?php echo e($readonlyRecord->reference_number ?: $readonlyRecord->student_number ?: optional($readonlyRecord->user)->student_number ?: '-'); ?></strong></div>
                                <div class="readonly-field"><span>Last Updated Nurse Tracking Remarks</span><strong><?php echo e($readonlyRecord->medical_condition_remarks ?: $readonlyRecord->pending_reason ?: '-'); ?></strong></div>
                            </div>
                        </div>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <form method="GET" class="health-filter-form" id="healthFilterForm">
            <div class="health-filter-field">
                ...
                <select id="courseFilter" name="course" class="health-filter-select">
                    ...
                    <?php $__currentLoopData = ($courseOptions ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courseOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($courseOption); ?>" <?php echo e(($courseFilter ?? '') === $courseOption ? 'selected' : ''); ?>><?php echo e($courseOption); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="health-filter-field">
            ...
            <div class="health-filter-field">
                ...
                <select id="yearFilter" name="year" class="health-filter-select">
                    ...
                    <?php $__currentLoopData = ($yearOptions ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yearOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($yearOption); ?>" <?php echo e((string) ($yearFilter ?? '') === (string) $yearOption ? 'selected' : ''); ?>><?php echo e($yearOption); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="health-filter-actions">
                <button type="submit" class="health-filter-btn">Apply</button>
                <a href="<?php echo e(route('admin.health_records')); ?>" class="health-filter-btn health-filter-btn-reset">Reset</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    const highlightedHealthId = <?php echo json_encode($highlightHealthId, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\INNOVISON---PUPOCMS\resources\views/admin/health_records.blade.php ENDPATH**/ ?>